    ...
    const handleSubmit = (e) => {
        ...
        for (const element of node.data.elements) {
            ...
            if (element.type === "input" || element.type === "date") {
                const { isValid, message } = validateInput(valueToValidate, element.validation, language);
                if (!isValid) {
                    alert(message);
                    return;
                }
...
export default function ScenarioBubble({ scenarioSessionId }) {
  ...
  return (
    ...
    >
      <div
        className={`GlassEffect ${styles.scenarioBubbleContainer} ${styles.collapsed} ${ // 항상 collapsed
      ...
      >
        ...
        >
          ...
          <div className={styles.headerButtons}>
            <ScenarioStatusBadge status={activeScenario?.status} t={t} isSelected={isFocused} />
            {!isCompleted && (
              <button
